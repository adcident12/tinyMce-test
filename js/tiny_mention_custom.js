...
(function () {
    ...
    var isPhone = detection.deviceType.isiPhone();
    var mobilePlugins = [
      'lists',
      'autolink',
      'autosave'
    ...
    var postProcessHooks = {}, filter$3 = Arr.filter, each$9 = Arr.each;
      ...
      var removeRngStyle = function (rng) {
        ...
        if (format.split) {
          ...
          if (startContainer !== endContainer) {
            ...
            if (dom.isChildOf(startContainer, endContainer) && startContainer !== endContainer && !dom.isBlock(endContainer) && !isTableCell$2(startContainer) && !isTableCell$2(endContainer)) {
    ...
    EditorManager = {
      ...
      $: DomQuery,
      majorVersion: '5',
      minorVersion: '0.0-preview-4-build.2',
      releaseDate: 'TBD',
